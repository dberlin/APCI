...
static struct apci_lookup_table_entry apci_driver_table[] =
    APCI_MAKE_DRIVER_TABLE(
        ...
        APCI_MAKE_ENTRY(PCI_IDI_48,0,(),6,(0,1,2,4,5,6)),
        APCI_MAKE_ENTRY(PCI_IDO_48,6,(0,1,2,4,5,6),0,()),
        APCI_MAKE_ENTRY(PCI_IDIO_16,2,(0,4),2,(1,5)),
        ...
        APCI_MAKE_DEFAULT_ENTRY(PCI_WDG_IMPAC),
        // APCI_MAKE_DEFAULT_ENTRY( MPCIE_DIO_24S ),
        APCI_MAKE_ENTRY(PCIe_IDIO_12,2,(0,1),3,(4,5)),
        APCI_MAKE_ENTRY(PCIe_IDIO_24,3,(0,1,2),3,(4,5,6)),
